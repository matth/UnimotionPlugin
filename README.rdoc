...
Follow these instructions to use the widget plugin within your Dashboard widgets.

Firstly copy the directory UnimotionPlugin.bundle into your widget's root directory. Once in place you must reference this in your widget's Info.plist file so it gets loaded in correctly. Add the following keys:
